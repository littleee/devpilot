const messages = {
  en: {
    ...
    "preview.title": "Checkout page with a visible UI issue",
    "preview.body":
    ...
    "preview.toolbarAnnotate": "Annotate",
    "preview.toolbarCopy": "Copy to AI",
    "preview.toolbarStability": "Stability",
  ...
  zh: {
    ...
    "preview.title": "在结算页里直接看到可定位的问题",
    "preview.body": "DevPilot 直接贴在页面上，所以问题会在真实出现的位置被记录下来。",
    "preview.ctaPrimary": "主操作",
    "preview.ctaSecondary": "次操作",
    "preview.toolbarAnnotate": "标注",
    "preview.toolbarCopy": "复制给 AI",
    "preview.toolbarStability": "稳定性",
